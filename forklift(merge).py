...
if uploaded_file is not None and 'df' in locals():
    ...
    if analysis_type == '운영 대수':
        ...
        summary_text = (
            f"<b>운영 횟수 전체: {summary.get('total_counts', 'N/A')}번 &nbsp;&nbsp;&nbsp;&nbsp; 운영 시간 전체: {summary.get('total_time', 'N/A')}</b><br>"
            ...
            f"일일 평균 운영: {summary.get('avg_counts', 'N/A')}번 ({float(summary.get('avg_counts_ratio', 0)):0.2f}%) &nbsp;&nbsp;&nbsp;&nbsp; "
