...
if uploaded_file is not None and 'df' in locals():
    ...
    if analysis_type == '운영 대수':
        summary_text = (
            ...
            f"평균: {int(summary.get('avg_units', 'N/A')}대 ({int(summary.get('avg_units_ratio', 0)):0.2f}%)<br>"
        )
    else:
        summary_text = (
            f"<b>운영 횟수</b><br>"
            ...
            f"평균: {int(summary.get('avg_counts', 'N/A')}번 ({int(summary.get('avg_counts_ratio', 0)):0.2f}%)<br>"
            f"<b>운영 시간</b><br>"
